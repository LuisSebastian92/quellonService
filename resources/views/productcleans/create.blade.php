...
<div class="container pt-3">
    <h1>
        Agregar Producto de Limpieza
    </h1>
    <form method="post" action="{{url('productcleans/create/store')}}" id="form">
    {{csrf_field()}}
    ...
    <a href="/productcleans/index" class="btn btn-primary" tabindex="5">Volver</a>
    </div>
